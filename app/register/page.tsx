          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8 items-start">
            ...
            <div className="space-y-6">
              <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                ...
                <p className="text-gray-700 text-lg mb-6 leading-relaxed">
                  Create your free account and instantly download "Are you ready for the IBHRE CCDS? How to pass!"
                </p>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900">Free Study Guide Included</h3>
                      <p className="text-gray-600 text-sm">Instant access upon registration - no credit card required</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900">Full Course Access $199</h3>
                      <p className="text-gray-600 text-sm">Comprehensive preparation with videos, practice exams, and expert guidance</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-900">Learn at Your Own Pace</h3>
                      <p className="text-gray-600 text-sm">Lifetime access to all course materials and updates</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-purple-50 to-blue-50 border border-purple-200 rounded-xl p-4">
                  <p className="text-sm text-gray-800">
                    <strong>💡 What You'll Learn:</strong> Device programming, troubleshooting, patient management, safety protocols, and advanced cardiac rhythm analysis - all structured around IBHRE exam requirements.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
              <div className="mb-6">
                ...
                <p className="text-gray-600">Join cardiac device professionals worldwide</p>
              </div>
              ...
              <form className="space-y-5" onSubmit={handleSubmit}>
                ...
                <p className="text-xs text-center text-gray-500 pt-2">
                  By creating an account, you agree to receive educational emails and course updates
                </p>
